...
subprocess.check_call(f"docker run --user={uid}:{gid} -v {siteDir}:/var/www -it tmp-deleteme bash -c \"cd /var/www && pip install django && django-admin startproject testsite\"", shell=True)
